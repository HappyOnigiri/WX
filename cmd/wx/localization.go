...
func translateHelp(text string, lang i18n.Language) string {
	...
	replacements := []struct{ en, ja string }{
		...
		{"stop managing a workspace", "workspace の管理を解除"},
		...
		{"Stop managing a workspace, reclaiming the worktrees wx still owns for it.", "workspace の管理を解除し、wx が保持している worktree を回収します。"},
