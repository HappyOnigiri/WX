...
ci-checks: fmt-check lint deadcode mod-tidy-check docs-check comments-check tests-check lines-check workflow-check shell-check coverage-check ci-test-race build-darwin smoke
