...
type Slot struct {
	...
	// FailurePhase は準備が止まった区間名で、区間の粒度まで分かる失敗にだけ入る。
	FailurePhase       string `json:"-"`
	DirIdentity        string
	Generation         int
