...
// 8 は回復案内、9 は measured_at、10 は補充停止の理由、11 は `wx slots` への置き換え、12〜13 は worktree_roots への unmanaged・shared/exclusive、14 は workspace_details への policy の追加である。
const JSONSchemaVersion = 15
