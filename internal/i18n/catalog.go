...
var catalog = map[string]Entry{
	...
	"menu.release.description":        {EN: "Return a worktree borrowed by a shell, a command, or \"borrow a worktree\" that was not returned when that process exited. Enter the session ID printed when it was borrowed.", JA: "シェル・コマンド・「worktree を借りるだけ」で借りた worktree のうち、プロセスが終了しても返却されていないものを返します。借りたときに表示された session ID を入力してください。"},
