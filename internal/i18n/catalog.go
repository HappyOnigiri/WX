...
var catalog = map[string]Entry{
	...
	"picker.search":                      {EN: "Search: ", JA: "検索: "},
	"picker.scope_this":                  {EN: "(this workspace)", JA: "（この workspace）"},
	"picker.scope_all":                   {EN: "(all workspaces · usage outside this workspace is unknown)", JA: "（全 workspace・workspace 外の使用状況は不明）"},
	"picker.no_sessions":                 {EN: "no sessions found", JA: "セッションが見つかりません"},
	"picker.no_match":                    {EN: "no conversations match the current filter", JA: "現在の絞り込みに一致する会話がありません"},
	"picker.in_use_selected":             {EN: "this session is in use and cannot be selected", JA: "このセッションは使用中のため選択できません"},
	"picker.not_resumable":               {EN: "this session cannot be resumed", JA: "このセッションは再開できません"},
	"picker.in_use":                      {EN: "in use", JA: "使用中"},
	"picker.usage_unknown":               {EN: "usage unknown", JA: "使用状況不明"},
	"picker.footer_move":                 {EN: "↑↓/Ctrl-N/Ctrl-P/PgUp/PgDn/Home/End move", JA: "↑↓/Ctrl-N/Ctrl-P/PgUp/PgDn/Home/End 移動"},
	"picker.footer_select":               {EN: "Enter select", JA: "Enter 選択"},
	"picker.footer_search":               {EN: "type to search", JA: "入力して検索"},
	"picker.footer_clear":                {EN: "Ctrl-U clear", JA: "Ctrl-U クリア"},
	"picker.footer_workspace":            {EN: "Ctrl-A workspace", JA: "Ctrl-A workspace"},
	"picker.footer_cancel":               {EN: "Esc clear → cancel", JA: "Esc クリア → キャンセル"},
	"select.cancelled":                   {EN: "Selection cancelled.", JA: "選択をキャンセルしました。"},
	"select.keys":                        {EN: "↑/↓ move · enter select · esc cancel", JA: "↑/↓ 移動 · Enter 選択 · Esc キャンセル"},
