...
func TestAllScalarFieldsCanBeSetAndReported(t *testing.T) {
	...
	values := map[string]string{
		...
		"discovery.max_depth": "4", "discovery.max_entries": "500", "discovery.timeout": "7s", "discovery.reconcile_interval": "8s", "readiness.timeout": "9s", "readiness.mode": "full", "readiness.progress": "false", "resume.auto_fresh": "true", "lease.ttl": "48h", "lease.shell": "/bin/zsh", "includes.default_agent_rules": "false", "agent.add_dir": "worktree", "logging.level": "debug", "update.auto_check": "false", "update.auto_apply": "false", "daemon.login_shell": "false",
	}
	var raw Config
