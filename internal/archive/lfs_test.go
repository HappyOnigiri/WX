...
func TestParseSnapshotTreeDiffSelectsNewRegularBlobs(t *testing.T) {
	...
	output := ":100644 100644 " + old + " " + newOID + " M\tweights.bin\x00" +
		":100644 000000 " + old + " " + deleted + " D\tremoved.bin\x00" +
		":100644 100644 " + old + " " + newOID + " M\tregular.txt\x00" +
		":100644 100644 " + old + " " + newOID + " M\t../unsafe\x00"
	...
	output = ":100644 100644 " + old + " " + newOID + " M\tweights.bin\x00" +
		":100644 000000 " + old + " " + deleted + " D\tremoved.bin\x00" +
		":160000 160000 " + old + " " + newOID + " M\tmodule\x00"
	changes, err = parseSnapshotTreeDiff(output)
	if err != nil || len(changes) != 1 || changes[0].path != "weights.bin" || changes[0].newOID != newOID {
